...
Future<List<Sentence>> postTextSample({text = '', context}) async {
  ...
  if (statusCode == 200) {
    // success
    final body = jsonDecode(_body) as List;
    body.forEach((e) {
      sentenceList.add(Sentence(
        text: e['sentence'] as String,
        suggestion: e['description'] as String,
